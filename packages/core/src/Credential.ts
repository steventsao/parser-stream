 ...
 */
export const Credential = Context.Reference<Option.Option<Redacted.Redacted<string>>>(
  "parser-stream/Credential",
...
): Effect.Effect<A, E, R> => Effect.provideService(effect, Credential, credential)
