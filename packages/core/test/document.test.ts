...
import { type DocumentInput, type DocumentState, initialState, reduce, validate } from "parser-stream/domain/Document"
import { encodeSse } from "parser-stream/domain/Events"
